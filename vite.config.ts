...
export default defineConfig({
          ...
          return [
            ...
            },
            {
              ...
              children: `
                ...
                watermark.href = 'https://www.srcbook.com?a_id=' + encodeURIComponent('01955336-1c91-7ef0-b310-f1e04eccbe89');
  ...
  base: process.env.NODE_ENV === 'production' ? '/absensi/' : '/', // Set base path for production
});
